    ...
    def index_document(self, document: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            es_doc = {
                ...
                "view_filename": document.get("view_filename") or document.get("filename", "Unknown"),
        ...
        for doc in documents:
            ...
            action = {
                ...
                "_source": {
                    ...
                    "view_filename": doc.get("view_filename") or doc.get("filename", "Unknown"),
        ...
        try:
            ...
            for hit in response['hits']['hits']:
                ...
                result = {
                    ...
                    "view_filename": source.get("view_filename") or (source.get("metadata", {}) or {}).get("view_filename"),
